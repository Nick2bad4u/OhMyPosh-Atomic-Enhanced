# Generated AtomicBit Theme Variants

## Scope

These instructions apply to `atomicBit/`.

## Rules

- Files in this folder are generated palette-only overlays that extend `atomicBit-Enhanced.omp.json`.
